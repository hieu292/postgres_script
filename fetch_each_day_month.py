...
CONNSTRING = "dbname=test user=postgres password=postgres host=localhost port=5432"
...
def list_book_for_month(year, month):
    """
    List all days for given month,
    and for each day list fact book entry.
    """
...
# run by command: ./fetch_1_month.py 2017 2
